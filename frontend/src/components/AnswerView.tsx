...
export function AnswerView({ query, answer, iterations, citations }: Props) {
  ...
  return (
    <div className="space-y-4">
          ...
          <ul className="space-y-2">
            {citations.map((c, i) => (
              ...
              >
                ...
                <div>
                  <span className="font-medium">{c.filename ?? c.document_id}</span>
      ...
      <style jsx global>{`
        .answer-prose h1 { font-size: 1.35rem; font-weight: 700; margin: 1.1rem 0 0.5rem; }
        .answer-prose h2 { font-size: 1.15rem; font-weight: 650; margin: 1rem 0 0.45rem; }
        .answer-prose h3 { font-size: 1.05rem; font-weight: 600; margin: 0.85rem 0 0.35rem; }
        .answer-prose p { margin: 0.55rem 0; }
        .answer-prose ul { list-style: disc; padding-left: 1.35rem; margin: 0.5rem 0; }
        .answer-prose ol { list-style: decimal; padding-left: 1.35rem; margin: 0.5rem 0; }
        .answer-prose li { margin: 0.25rem 0; }
        .answer-prose code {
        ...
        .dark .answer-prose code { background: rgba(255, 255, 255, 0.08); }
        .answer-prose pre {
          background: rgba(0, 0, 0, 0.06);
        ...
        .dark .answer-prose pre { background: rgba(255, 255, 255, 0.06); }
        .answer-prose pre code { background: transparent; padding: 0; }
        .answer-prose table {
          width: 100%;
        ...
        .answer-prose th { background: rgba(0, 0, 0, 0.04); font-weight: 600; }
        .dark .answer-prose th { background: rgba(255, 255, 255, 0.06); }
        .answer-prose strong { font-weight: 650; }
